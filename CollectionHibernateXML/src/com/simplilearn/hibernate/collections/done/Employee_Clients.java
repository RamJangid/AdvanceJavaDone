...
//			empreference.put(null, null);
//			empreference.put(null, null);
//			empreference.put(null, null);
//			empreference.put(null, null);
			
			empreference.put("Aj Style1", new Long(12341));
			empreference.put("Aj Style2", new Long(12342));
			empreference.put("Aj Style3", new Long(12343));
			empreference.put("Aj Style4", new Long(12344));
...
//			private Map<String, Long> empreference;
			...
			Employee employee = new Employee(23,"Triple", "010195", "MCA", empcourse, empemails, empmarks, empphone, empreference);
