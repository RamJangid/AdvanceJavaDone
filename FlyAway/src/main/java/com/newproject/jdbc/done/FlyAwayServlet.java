...
{
	public static final String INSERT = "INSERT INTO TRAVEL_DETAILS VALUES(?,?,?,?)";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			request.setAttribute("D_Of_Trvl", Date_Of_Travel);
			request.setAttribute("SRC", Source);
			request.setAttribute("Dstn", Destination);
			request.setAttribute("NO_Of_Prsn", No_Of_Person);
			
			System.out.println("Let's forward to showFlight.js");
