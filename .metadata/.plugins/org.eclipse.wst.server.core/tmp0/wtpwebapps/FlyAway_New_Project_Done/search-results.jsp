...
<div class="container">
    ...
    <p align="center"><span><strong>
        Showing available flights from <%=Search.source_place%> to  <%=Search.destination_place%> <br>
        Date of travel : <%=Search.date_of_travel%> (<%=Search.date_of_travel%>)  <br>
        ...
        <tr bgcolor="#F5F5F5">
            ...
            <td>
                <form action="${pageContext.request.contextPath}/booking-details.jsp" method="post">
                    ...
                    <input type="hidden" id="flight_number" name="flight_number" value="<%=resultSet.getString("flight_number")%>">
